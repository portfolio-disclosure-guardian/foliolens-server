...
public final class GoldFacility001Fixture {
    ...
    public static AnswerPolicy policy() {
        return new AnswerPolicy(
                ...
                // 아래 두 건은 SGF 골든셋과 무관하게, 이미 실 DB(disclosure_facts/disclosure_evidences)에
                // 적재된 신규시설투자등 43건 원문 fact를 그대로 옮긴 draft다. 역할 C가 질문 문구·기대
                // 답변·criticalErrors를 검토해 승인하기 전까지는 C_REVIEW_PENDING으로 둔다.
                new GoldenCase(
                        "GOLD-FACILITY-002",
                        "셀트리온이 2026년 3월 발표한 신규시설투자의 투자금액과 목적은 무엇이고, 자기자본 대비 비율은 맞는가?",
                        "셀트리온",
                        "20260324800030",
                        Map.of(
                                "facility.target", "송도 캠퍼스 내 제4, 5공장 신설",
                                "facility.amount", "1226500000000",
                                "facility.equity_amount", "17580062368691",
                                "facility.equity_ratio", "6.98",
                                "facility.purpose", "- 상업화 파이프라인 확대와 시장 수요 증가에 따른 대응 및 안정적 공급망 구축 "
                                        + "- CDMO 사업 본격화에 따른 선제적 생산능력 확보",
                                "facility.start_date", "2026-04-01",
                                "facility.end_date", "2030-12-31",
                                "facility.decision_date", "2026-03-24"
                        ),
                        "6.9766532921084533760000000",
                        "6.98",
                        CalculationVerdict.MATCH,
                        AnswerOutcome.COMPLETED,
                        "대회 제공 공시 원문에 따르면, 셀트리온이 2026년 3월 결정한 송도 캠퍼스 내 제4, 5공장 신설의 "
                                + "투자금액은 1조 2,265억 원이며, 투자목적은 상업화 파이프라인 확대와 시장 수요 증가에 따른 "
                                + "대응 및 안정적 공급망 구축, CDMO 사업 본격화에 따른 선제적 생산능력 확보입니다. 공시에 "
                                + "기재된 최근 사업연도 말 연결 자기자본 17조 5,800억 6,236만 8,691원을 기준으로 투자금액 "
                                + "÷ 자기자본 × 100을 계산하면 약 6.9767%입니다. 이를 공시와 동일하게 소수 둘째 자리로 "
                                + "반올림하면 6.98%이므로 공시된 자기자본 대비 비율과 일치합니다. 다만 공시 원문은 "
                                + "투자금액과 투자기간이 진행 과정 및 경영환경에 따라 변경될 수 있다고 밝히고 있습니다.",
                        List.of(
                                "자기자본 분모 오추출 또는 연결·별도 기준 혼용",
                                "목적 문구 왜곡",
                                "계획금액을 실제 집행액으로 표현",
                ...
                new GoldenCase(
                        "GOLD-FACILITY-003",
                        "LG이노텍이 2025년 11월 발표한 신규시설투자의 투자금액과 목적은 무엇이고, 자기자본 대비 비율은 맞는가?",
                        "LG이노텍",
                        "20251127800903",
                        Map.of(
                                "facility.target", "광학솔루션사업부 시설투자",
                                "facility.amount", "341100000000",
                                "facility.equity_amount", "5353865612478",
                                "facility.equity_ratio", "6.4",
                                "facility.purpose", "광학솔루션 사업 신모델 대응 및 경쟁력 향상을 위한 투자",
                                "facility.start_date", "2025-11-27",
                                "facility.end_date", "2026-12-31",
                                "facility.decision_date", "2025-11-27"
                        ),
                        "6.3710975338083654870000000",
                        "6.4",
                        CalculationVerdict.MATCH,
                        AnswerOutcome.COMPLETED,
                        "대회 제공 공시 원문에 따르면, LG이노텍이 2025년 11월 결정한 광학솔루션사업부 시설투자의 "
                                + "투자금액은 3,411억 원이며, 투자목적은 광학솔루션 사업 신모델 대응 및 경쟁력 향상을 위한 "
                                + "투자입니다. 공시에 기재된 최근 사업연도 말 연결 자기자본 5조 3,538억 6,561만 2,478원을 "
                                + "기준으로 투자금액 ÷ 자기자본 × 100을 계산하면 약 6.3711%입니다. 공시와 동일하게 소수 "
                                + "첫째 자리로 반올림하면 6.4%이므로 공시된 자기자본 대비 비율과 일치합니다. 다만 공시 "
                                + "원문은 투자금액과 투자기간이 진행 과정 및 경영환경에 따라 변경될 수 있다고 밝히고 있습니다.",
                        List.of(
                                "자기자본 분모 오추출 또는 연결·별도 기준 혼용",
                                "목적 문구 왜곡",
                                "계획금액을 실제 집행액으로 표현",
